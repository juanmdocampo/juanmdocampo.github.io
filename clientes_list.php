...
<section class="container-fluid fondo-color "> <!-- imagen-fondo imagen-contenida -->
	<article class="row">
	   <div class="col-12 col-md-12"> <br/> <h2 class="centrar">Listado de publicaciones de Clientes</h2> </div>
                   ...
                   <div class="container-fluid">
                    <div class="row">
                            ...
                            <div class="col-12  col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-7">
                              <div class="card-body">
                                <h5 class="card-title">Asunto:  '.$field[$loop][2].'</h5>
...
<!-- Footer -->
<footer class="page-footer font-small nav-color darken-3 container-fluid">
